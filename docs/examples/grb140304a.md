...
![GRB 140304A radio light curves](img/grb140304a_radio.png)
...
![GRB 140304A radio SEDs](img/grb140304a_sed.png)
...
![GRB 140304A X-ray afterglow](img/grb140304a_xray.png)
...
The complete analysis script is at [`examples/grb140304a_energy_injection.py`](https://github.com/nuclear-multimessenger-astronomy/blastwave/blob/main/examples/grb140304a_energy_injection.py). To regenerate the plots:

```bash
python examples/grb140304a_energy_injection.py
```
